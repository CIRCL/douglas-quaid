    ...
    def test_merge_graphs(self):
        ...
        self.assertDictEqual(new_graph, {'clusters': [{'group': '',
                                                      ...
                                                      {'group': '',
                                                       ...
                                                       'members': ['1_0OLD', '1_1OLD', '1_2OLD'],
                                                       'shape': 'image'}],
                                         'edges': [{'color': 'green', 'from': '0_0OLD', 'to': 0},
                                                   {'color': 'green', 'from': '0_1OLD', 'to': 0},
                                                   {'color': 'green', 'from': '0_2OLD', 'to': 0},
                                                   {'color': 'red', 'from': '1_0OLD', 'to': 1},
                                                   {'color': 'orange', 'from': '1_0OLD', 'to': 2},
                                                   {'color': 'red', 'from': '1_1OLD', 'to': 1},
                                                   {'color': 'orange', 'from': '1_1OLD', 'to': 2},
                                                   {'color': 'red', 'from': '1_2OLD', 'to': 1},
                                                   {'color': 'orange', 'from': '1_2OLD', 'to': 2}],
                                         'meta_1': {'source': 'VISJS'},
