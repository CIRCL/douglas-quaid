...
class TestClusterMatcher(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_path = get_homedir() / "carlhauser_client_tests" / "API" / "SimpleAPI"
    ...
    def test_get_results(self):
        ...
        self.assertListEqual(results["list_pictures"], awaited_result)
    ...
    def test_is_result_ready(self):
        ...
        success, ready = self.api.is_result_ready(request_id, 0)
        self.assertEqual(success, True)
